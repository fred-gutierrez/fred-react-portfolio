    ...
    <div className="col-12 col-md-6 col-lg-6 text-white">
      ...
      <div className="row mt-5">
        <div className="col-6 col-lg-4">
          ...
          <p className="text-white text-center mt-1">Sass</p>
        </div>
        ...
        <div className="col-6 col-lg-4">
          ...
          <p className="text-white text-center mt-1">React</p>
        </div>
        <div className="col-6 col-lg-4">
          <div className="d-flex justify-content-center">
            <img
          ...
          <p className="text-white text-center mt-1">TypeScript</p>
        </div>
        ...
        <div className="col-6 col-lg-4">
          ...
          <p className="text-white text-center mt-1">Bootstrap</p>
        </div>
        ...
        <div className="col-6 col-lg-4">
          ...
          <p className="text-white text-center mt-1">PostCSS</p>
        </div>
        ...
        <div className="col-6 col-lg-4">
          ...
          <p className="text-white text-center mt-1">Tailwind</p>
        </div>
        ...
        <div className="col-6 col-lg-4">
          ...
          <p className="text-white text-center mt-1">WordPress</p>
        </div>
        ...
        <div className="col-6 col-lg-4">
          ...
          <p className="text-white text-center mt-1">GreenSock</p>
        </div>
        ...
        <div className="col-12 col-lg-4">
          ...
          <p className="text-white text-center mt-1">Gatsby</p>
        </div>
      </div>
    </div>
  );
